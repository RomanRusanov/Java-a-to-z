...
public class TrackerTest {
    ...
    public void thenArgTypeLongWhenReturnStringDateAndTime() {
        Tracker tracker = new Tracker();
        final String expect = "29.01.17 17:01:00.000";
    ...
    public void thenArgTypeStringWhenReturnLongDataAndTimeInMillis() {
        ...
        final long result = tracker.convert("29.01.17 17:01:00.000");
        Assert.assertThat(result, is(expect));
    }
    /**
    ...
    public void thenSearchingDateAndTimeEqualsDateAndTimeInItemsArrayWhenReturnThem() {
        Tracker tracker = new Tracker();
        tracker.add(new Item("name", "desc",  tracker.convert("01.01.70 12:00:00.000"), "comm"));
        final ArrayList<Item> result = tracker.findByCreate("01.01.70 12:00:00.000");
        Assert.assertTrue(result.get(0).getCreate() == tracker.convert("01.01.70 12:00:00.000"));
    }
}
