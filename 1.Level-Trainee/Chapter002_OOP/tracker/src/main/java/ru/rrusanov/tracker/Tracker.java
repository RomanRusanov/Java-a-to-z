...
public class Tracker implements ITracker {
    ...
    public void fieldsUpdate(Item item, Input input) {
        ...
        String create = input.ask("Enter new date and time(31.12.1970 23:59:59.000)(or press Enter to leave old value):");
        if (!"".equals(create)) {
     ...
     * @return string date and time "31.12.1970 23:59:59.999"
     */
    ...
    /**
     * Convert string value date and time "31.12.1970 23:59:59.999" to millisecond value.
